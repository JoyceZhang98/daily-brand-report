...
export default function Home() {
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-950 text-gray-100 font-mono text-xs">
      <div className="flex-none bg-gray-900 border-b border-gray-700 px-4 py-3 flex flex-wrap items-center gap-4 z-20">
        <div>
          ...
          <table className="w-full border-collapse text-xs">
            <thead className="bg-gray-800 sticky top-0 z-10">
              <tr className="text-gray-300 border-b border-gray-700">
                <th className="px-2 py-1 text-left text-gray-500 bg-gray-800" rowSpan={2}>#</th>
                <th className="px-2 py-1 text-left bg-gray-800 sticky left-0 z-10" rowSpan={2}>Brand</th>
